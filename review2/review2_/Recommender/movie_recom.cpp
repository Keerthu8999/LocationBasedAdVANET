...
int main(int argc, char ** argv) {
	...
	string advertisement_title_file="/home/keyrooh/Desktop/rec/movie_title.txt";
	string rating_file="/home/keyrooh/Desktop/rec/ratings.txt";

	if(argc==3){
		advertisement_title_file=argv[1];
		rating_file=argv[2];
